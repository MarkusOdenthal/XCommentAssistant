...
from knowledge_storm.lm import OpenAIModel, AzureOpenAIModel, ClaudeModel
...
def main(args):
    ...
    gpt_4o_mini_model_name = 'gpt-4o-mini' if os.getenv('OPENAI_API_TYPE') == 'openai' else 'gpt-4o-mini'
    sonnet_35_model_name = 'claude-3-5-sonnet-20240620'
    ...
    conv_simulator_lm = ModelClass(model=gpt_4o_mini_model_name, max_tokens=500, **openai_kwargs)
    question_asker_lm = ModelClass(model=gpt_4o_mini_model_name, max_tokens=500, **openai_kwargs)
    outline_gen_lm = ClaudeModel(model=sonnet_35_model_name, max_tokens=400, **claude_kwargs)
    article_gen_lm = ClaudeModel(model=sonnet_35_model_name, max_tokens=700, **claude_kwargs)
    article_polish_lm = ClaudeModel(model=sonnet_35_model_name, max_tokens=4000, **claude_kwargs)
